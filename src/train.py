...
if __name__ == '__main__':
    ...
    parser.add_argument("-model", default='robert', type=str, choices=['robert', 'bert', 'pubmed','biobert','longformer'])
    ...
    # adapter details
    parser.add_argument("-adapter_training_strategy",default='discriminative',choices=['discriminative', 'both', 'generative','basic'])
    ...
    # number of documents per batch. If total tokens in all documents exceed max_pos, this will only include the
    # number of documents up to the amount that adds up to max_pos
    ...
    parser.add_argument('-log_file', default='../logs/ext_bert_covid.log')
